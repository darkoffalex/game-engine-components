    ...
    glViewport(0,0,(GLsizei)glfw->display_width,(GLsizei)glfw->display_height);
    {
        ...
        nk_draw_foreach(cmd, &glfw->ctx, &dev->cmds)
        {
            ...
            glScissor(
                ...
                (GLint)(glfw->height - (int)((cmd->clip_rect.y + cmd->clip_rect.h) * glfw->fb_scale.y)),
...
{
    auto* glfw = (nk_glfw*)glfwGetWindowUserPointer(win);
...
nk_glfw3_new_frame(struct nk_glfw* glfw)
{
    ...
    /* update the timer */
    auto delta_time_now = (float)glfwGetTime();
